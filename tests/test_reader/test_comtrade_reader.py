...
class TestComtrade(unittest.TestCase):
    ...
    def test_get_raw_by_analog_indices(self):
        ...
        self.assertEqual(7940, ysz1[2].raw[4])
    ...
    def test_get_instant_by_digital(self):
        ...
        self.assertEqual(3077, len(digital[0].raw))
